<?php
  ...
  $sqlre= "SELECT * FROM tb_man_konsi 
  INNER JOIN tb_staff ON tb_staff.kode_staff=tb_man_konsi.counter_mk 
...
<body>
  ...
  <br><br><br><br><br><br><br><br>
    ...
    <div class='separo' align="center"> <font face='sans serif' size='3'><b> MANUAL KONSI</b></font></div>
    <p>&nbsp;</p>
    <font face='arial' size='2'>No.Invoice : <?php echo $nota; ?> <br> </font>
    <font face='arial' size='2'>Customer  : <?php echo $rowre['cs_mk'];  ?> <br> </font>
    <font face='arial' size='2'>Keterangan  : <?php echo $rowre['keterangan_mk']; ?> </font>
  ...
  <?php
    ...
    $bayar=0;
    $query2="SELECT * FROM tb_detail_mankonsi INNER JOIN tb_man_konsi ON tb_man_konsi.id_mk=tb_detail_mankonsi.nota_detmk 
    ...
    while($baris2 = mysqli_fetch_assoc($result2)){
      $bayar=$bayar+$baris2['totjum_detmk'];
      $produk=$baris2['id_produk'];
      $totju=$baris2['total_mk'];    
  ?>
      <tr>
        <td width="30%"><font face='verdana' size='2'><?php echo $baris2['id_produk']; ?><br>(<?php echo $baris2['qty_detmk']; ?>)</font></td>
        <td width="35%"><font face='verdana' size='2'><?php echo $baris2['nama_produk']; ?><br>(<?php echo rupiah($baris2['harga_harian']); ?>)</font></td>
        <td width="6%"><font face='verdana' size='2'><?php echo rupiah($baris2['diskon_detmk']); ?></font></td>
        <td width="20%"><font face='verdana' size='2'><?php echo rupiah($baris2['totjum_detmk']); ?></font></td>
      </tr>
  ...
  ?>  
      ...
      <tr>
        ...
        <td colspan="3"><font face='verdana' size='2'>  : <?php echo rupiah(0); ?></font></td>
      </tr>
      <tr>
      ...
      <tr></tr> <tr></tr> <tr></tr> 
      <tr>
        <td width="25%" colspan="4"><font face='verdana' size='2'>Jenis Transaksi : <?php echo $rowre['jenis_mk']." - ".$rowre['cara_bayar_mk']; ?></td>
      </tr>
      <tr>
        <td width="25%" colspan="4"><font face='verdana' size='2'>Tanggal dan Waktu : <?php echo date("d-m-Y H:i:s", strtotime($rowre['tgl_order_mk'])); ?>  </td>
      </tr>
      <tr>
