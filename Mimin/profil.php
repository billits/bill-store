<?php
  ...
  if(isset($_POST["submit"])) {
    ...
    if (empty($uname)||empty($pwd)){
      echo "<script type='text/javascript'>alert('Data Tidak Boleh Kosong !');window.location='profil.php';</script>";
    }else{
      ...
      if ($countr!=0){
        echo "<script type='text/javascript'>alert('Username Sudah Digunakan !');window.location='profil.php';</script>";
      }else{
        ...
        if ($cek==0){
          ...
          echo "<script type='text/javascript'>alert('Data Berhasil Dirubah');window.location='profil.php';</script>";
        }else{          
          mysqli_rollback($kon);
          header("HTTP/1.1 302 Found");
        ...
        <div class="container-fluid">
          ...
          <?php
            ...
            $sqlre= "SELECT * FROM tb_staff 
                      ...
                      WHERE tb_staff.kode_staff='$pg' AND tb_akses.status_akses='ADMIN'";
