  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Detail Events</li>
          </ol>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        var dataevt = "data_det_event.php";
        ...
        $(document).on('click','#upkan',function(e){
          e.preventDefault();
          var pid = $(this).attr('data-id');
          var pnama = $(this).attr('data-nama');
          bootbox.dialog({
            message: "Apakah Anda Ingin MengAktifkan Event "+pnama+" ?",
            title: "",
            buttons: {
              danger: {
                label: "Ya",
                className: "btn-success",
                callback: function() {
                  $.post('../db_proses/on_events.php', { 'mati':pid })
                  .done(function(html){             
                    $('#DataEvents').load(dataevt);
                  })
                  .fail(function(){
