                ...
                <div class="modal-body">
                  <form method="post" id="form-tambah">
                    <div class="form-group" style="padding-bottom: 20px;">
                      ...
                      <input type="text" name="kode_events"  id="kode_events" class="form-control" placeholder="Kode Events (Maksimal 3 Huruf)" required/>
                    </div>
                    <div class="form-group" style="padding-bottom: 20px;">
                    ...
                    <div class="form-group" style="padding-bottom: 20px;">
                      <label for="telepon">Tingkat Events*</label>
                      <select class="form-control" name="level_evt" id="level_evt" required>
