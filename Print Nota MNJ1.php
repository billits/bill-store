<?php
  ...
  $sqlre= "SELECT * FROM tb_man_trans 
  INNER JOIN tb_staff ON tb_staff.kode_staff=tb_man_trans.counter_mt 
  INNER JOIN tb_office ON tb_office.id_office=tb_man_trans.kantor_mt 
  WHERE tb_man_trans.id_mt='$nota'";
	$resultre = mysqli_query($kon,$sqlre);
  $rowre = mysqli_fetch_array($resultre,MYSQLI_ASSOC);
  $acara=$rowre['acara_mt'];
  
  $sqlre2= "SELECT * FROM tb_detail_events WHERE id_det_event='$acara'";
...
<body>
  ...
  <br><br><br><br><br><br><br><br>
    ...
    <div class='separo' align="center"> <font face='sans serif' size='3'><b> MANUAL</b></font></div>
    <p>&nbsp;</p>
    <font face='arial' size='2'>No.Invoice : <?php echo $nota; ?> <br> </font>
    <font face='arial' size='2'>Acara : <?php echo $rowre2['nama_det_event']; ?> <br> </font>
    <font face='arial' size='2'>Customer  : <?php echo $rowre['cs_mt'].' - '.$rowre['tlp_mt'];  ?> <br> </font>
    <font face='arial' size='2'>Keterangan  : <?php echo $rowre['keterangan_mt']; ?> </font>
  ...
  ?>
      <tr>
        <td width="30%"><font face='verdana' size='2'><?php echo $baris2['id_produk']; ?><br>(<?php echo $baris2['qty_detmt']; ?>)</font></td>
        <td width="35%"><font face='verdana' size='2'><?php echo $baris2['nama_produk']; ?><br>(<?php echo rupiah($baris2['harga_harian']); ?>)</font></td>
        <td width="6%"><font face='verdana' size='2'><?php echo rupiah($baris2['diskon_detmt']); ?></font></td>
        <td width="20%"><font face='verdana' size='2'><?php echo rupiah($baris2['total_jumlah_detmt']); ?></font></td>
      </tr>
  ...
  ?>  
      ...
      <tr></tr> <tr></tr> <tr></tr> 
      <tr>
        <td width="25%" colspan="4"><font face='verdana' size='2'>Jenis Transaksi : <?php echo $rowre['jenis_mt']." - ".$rowre['cara_bayar_mt']; ?></td>
      </tr>
      <tr>
        <td width="25%" colspan="4"><font face='verdana' size='2'>Tanggal dan Waktu : <?php echo date("d-m-Y H:i:s", strtotime($rowre['tgl_order_mt'])); ?>  </td>
      </tr>
      <tr>
