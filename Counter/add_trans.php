  ...
  <body id="page-top">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class='modal-title' id='exampleModalLabel'>Transaksi Office</h5>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var datastok = "data_trans.php?nota="+idnota;
        $('#Transaksi').load(datastok); 

        $(document).on('click','#addpro',function(e){
          e.preventDefault();
          window.location= 'add_trans_pro.php?nota='+idnota;
        });
          ...
          $.ajax({
            ...
            success:function(result){
              ...
              if(obj.nilai===1){
                ...
                window.location= 'transaksi_off.php';
              }else{
                alert(obj.error); 
              }
            }
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                callback: function() {
                  $.post('../db_proses/delete_trans.php', { 'kode_nota':pnot, 'kode_produk':ppdk, 'jum_produk':pjum })
                  .done(function(html){      
                    $('#Transaksi').load(datastok);   
                  })
                  .fail(function(){
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                className: "btn-success",
                callback: function() {
                  $.post('../db_proses/delete_transaksi.php', { 'kode_nota':pnot })
                  .done(function(html){             
                    window.location= 'transaksi_off.php';
                  })
                  .fail(function(){
