  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          <!-- Breadcrumbs-->
          <ol class="breadcrumb">
            Transaksi Events <?php echo $_COOKIE['office_bill']; ?>
          </ol>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var datastok = "data_trans_evt.php?nota="+idnota;
        $('#Transaksi').load(datastok); 

        $(document).on('click','#addpro',function(e){
          e.preventDefault();
          window.location= 'add_trans_pro_evt.php?nota='+idnota;
        });
          ...
          $.ajax({
            ...
            success:function(result){
              ...
              if(obj.nilai===1){
                ...
                window.location= 'transaksi_det_evt.php?evt='+evtt_tmp;
              }else{
                alert(obj.error); 
              }
            }
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                callback: function() {
                  $.post('../db_proses/delete_trans_evt.php', { 'kode_nota':pnot, 'kode_produk':ppdk, 'jum_produk':pjum })
                  .done(function(html){      
                    $('#Transaksi').load(datastok);   
                  })
                  .fail(function(){
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                className: "btn-success",
                callback: function() {
                  $.post('../db_proses/delete_transaksi_evt.php', { 'kode_nota':pnot })
                  .done(function(html){             
                    window.location= 'transaksi_det_evt.php?evt='+pevtt;
                  })
                  .fail(function(){
                    bootbox.alert('Something Went Wrog ....');
                  })
