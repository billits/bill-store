  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Gudang Event <?php echo $_COOKIE['office_bill']; ?> </li>
          </ol>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        var datapro = "data_pro_event.php";
        ...
        $('#form-ev').submit(function(e){
          ...
          var dataevt = "data_detpro_event.php?evt="+datatmp;
          $('#DataProduk').load(dataevt); 
        })
