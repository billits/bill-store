<?php
  ...
  // $sqlre= "SELECT * FROM tb_jual INNER JOIN tb_detail_events ON tb_detail_events.id_det_event=tb_jual.acara_jual WHERE tb_jual.id_jual='$nota'";
  // $resultre = mysqli_query($kon,$sqlre);
  // $rowre = mysqli_fetch_array($resultre,MYSQLI_ASSOC);

  // $event = $rowre['id_det_event'];  
...
?>
                  ...
                  <form method="post" id="form-jum">
                    ...
                    <div class="form-group" style="padding-bottom: 20px;">
                      ...
                      <input class="form-control" type="text" name="kategori" readonly id="kategori" value="<?php echo $baris['id_kategori']; ?>" required/>  
                    </div>
                    <div class="form-group" style="padding-bottom: 20px;">
                    ...
                    <div class="form-group" style="padding-bottom: 20px;">
                      <label for="jumlah">Diskon (Rp)*</label>
                      <input class="form-control" type="text" name="diskon" id="diskon" value="0" onkeyup="myFunction()" required/>  
                    </div>
                    <div class="form-group" style="padding-bottom: 20px;">
                      ...
                      <input class="form-control" type="hidden" name="cate" id="cate" value="<?php echo $baris['id_kategori']; ?>"readonly required/>  
                      <input class="form-control" type="hidden" name="nota" id="nota" value="<?php echo $nota; ?>"readonly required/>    
                      <!-- <input class="form-control" type="hidden" name="event" id="event" value="<?php echo $event; ?>"readonly required/>   -->
