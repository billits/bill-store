  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> List Manual Transaksi Office <?php echo $_COOKIE['office_bill']; ?></li>
          </ol>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        var datatrans = "data_list_mt.php";
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "data_detail_list_mt.php?id="+datatmp+"&ct="+datact;
