  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          <!-- Breadcrumbs-->
          <ol class="breadcrumb">
            Manual Transaksi Office <?php echo $_COOKIE['office_bill']; ?>
          </ol>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class='modal-title' id='exampleModalLabel'>Manual Transaksi Office</h5>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var datastok = "data_man_trans.php?nota="+idnota;
        $('#Transaksi').load(datastok); 

        $(document).on('click','#addpro',function(e){
          e.preventDefault();
          window.location= 'add_mantrans_pro.php?nota='+idnota;
        });
          ...
          $.ajax({
            ...
            success:function(result){
              ...
              if(obj.nilai===1){
                ...
                window.open(
                  '../Print Nota MNJ.php?nota='+nota_tmp,
                  '_blank' // <- This is what makes it open in a new window.
                );
                window.location= 'man_trans.php';
              }else{
                alert(obj.error); 
              }
            }
