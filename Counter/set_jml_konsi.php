<?php
  ...
  $query = "SELECT * FROM tb_produk INNER JOIN tb_kategori ON tb_kategori.id_kategori=tb_produk.kategori_produk 
	...
	WHERE tb_office.id_office='$office' AND tb_harga_produk.status_harga='ON' AND tb_produk.id_produk='$pdk' limit 1";
...
?>
                  ...
                  <form method="post" id="form-jum">
                    ...
                    <div class="form-group" style="padding-bottom: 20px;">
                      ...
                      <input class="form-control" type="hidden" name="topro" id="topro" value="<?php echo $topro; ?>"readonly required/>  
