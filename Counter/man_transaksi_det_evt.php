...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <?php
      ...
      $query = "SELECT * FROM tb_detail_events INNER JOIN tb_events ON tb_events.id_events=tb_detail_events.event_det_event WHERE tb_detail_events.status_det_event='ON'";
    ...
    <script type="text/javascript"> 
      ...
      $(document).ready(function(){
        ...
        var dataevt = "data_det_man_trans_evt.php?evt="+datatmp;
        $('#DataEvents').load(dataevt);  

        $(document).on('click','#kembali',function(e){
          e.preventDefault();
          window.location= 'man_trans_evt.php';
        });
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "data_detail_man_trans_evt.php?id="+datatmp;
        ...
        $(document).on('click','#addtrans',function(e){
          ...
          $.ajax({
            url:"../db_proses/add_newman_trans_evt.php",
            type:"POST",
            data: event_note,
            success:function(result){
              var obj= JSON.parse(result);
              if(obj.nilai===1){
                window.location= 'add_man_trans_evt.php?nota='+obj.nota;
                //alert(obj.error); 
              }else{
                alert(obj.error); 
              }
