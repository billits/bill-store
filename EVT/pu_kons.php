...
<html lang="en">
  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Print Ulang Konsinyasi Event</li>
          </ol>

          <!-- DataTables Example -->
          <div class="card mb-3">
            <div class="card-body">
              <form method="get" id="form-approv" action="view_kons.php">
    ...
    <?php
      ...
      WHERE detail_events.office_det_event='$kantor' ORDER BY detail_events.id_det_event DESC";
