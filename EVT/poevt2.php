      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">            
            ...
            <li class="breadcrumb-item active">PO Event Kecil <?php echo $_COOKIE['office_bill']; ?></li>
          </ol>
                        ...
                        <select class="form-control m-bot15" name="event" id="event">
                          ...
                          <?php
                            ...
                            while($baris = mysqli_fetch_assoc($result)){
                              if ($baris['event_det_event']!='BIG' && $baris['event_det_event']!='BST' && $baris['event_det_event']!='BMW' && $baris['event_det_event']!='RTS' && $baris['event_det_event']!='BCP' && $baris['event_det_event']!='ELT'){
                          ?>
        ...
        $(document).on('click','#addstok',function(e){
          ...
          $.ajax({
            ...
            success:function(data){
              ...
              if(obj.nilai===1){
                window.location= 'add_stokevt2.php?nota='+obj.nota+"&evn="+obj.acara;
              }else{
                alert(obj.error); 
              }
            }
