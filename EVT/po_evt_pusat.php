...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-body">
              <form method="post" id="form-approv" action="view_evt_pusat.php">
    ...
    <?php
      ...
      $query1 = "SELECT * FROM office WHERE id_office!='PST'";
    ...
    <?php
      ...
      WHERE detail_events.event_det_event='BST' OR detail_events.event_det_event='RTS' OR detail_events.event_det_event='BIG' OR detail_events.event_det_event='BMW' OR detail_events.event_det_event='BCP' OR detail_events.event_det_event='ELT'";
