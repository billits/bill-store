    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $('#form-tambah').submit(function(e){
          ...
          $.ajax({
            url:"http://localhost/BillServer/add_region.php",
            type:"POST",
            data: dataform,
        ...
        $("#form-edit-region").submit(function(e) {
          ...
          $.ajax({
            url: "http://localhost/BillServer/update_region.php",
            type: "POST",
            data: dataform,
            success:function(result){
              var obj= JSON.parse(result);
        ...
        $(document).on('click','#hapus',function(e){
          ...
          bootbox.dialog({
            message: "Apakah Anda Ingin Menghapus Data Region ?",
            title: "",
            buttons: {
              danger: {
                label: "Ya",
                ...
                callback: function() {
                  $.post('http://localhost/BillServer/delete_region.php', { 'delete':pid })
                  .done(function(html){
                    $('#lala').load(datareg);      
                  })
                  .fail(function(){
