    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $('#form-tambah').submit(function(e){
          ...
          $.ajax({
            url:"http://localhost/BillServer/add_katpro.php",
            type:"POST",
            data: dataform,
        ...
        $("#form-edit").submit(function(e) {
          ...
          $.ajax({
            url: "http://localhost/BillServer/update_kategori.php",
            type: "POST",
            data: dataform,
            success:function(result){
              var obj= JSON.parse(result);
        ...
        $(document).on('click','#hapus',function(e){
          ...
          bootbox.dialog({
            message: "Apakah Anda Ingin Menghapus Data Kategori Produk ?",
            title: "",
            buttons: {
              danger: {
                label: "Ya",
                ...
                callback: function() {
                  $.post('http://localhost/BillServer/delete_kategori.php', { 'delete':pid })
                  .done(function(html){
                    $('#DataKatProduk').load(datakat);      
                  })
                  .fail(function(){
