<?php
  ...
  $query = "SELECT * FROM tb_detail_po 
	...
	WHERE tb_detail_po.nota_detpo='$id' AND tb_detail_po.produk_detpo='$pdk'";
...
?>
                  ...
                  <form method="post" id="form-edit">
                    ...
                    <div class="form-group" style="padding-bottom: 20px;">
                      ...
                      <input class="form-control" type="text" name="qty" id="qty" value="<?php echo $baris['qty_detpo']; ?>" placeholder="Qty" onkeyup="myFunction()" required/>  
                    </div>
                    <div class="form-group" style="padding-bottom: 20px;">
                      ...
                      <input class="form-control" type="hidden" name="jum_old" id="jum_old" value="<?php echo $baris['total_jumlah_detpo']; ?>"/>
                  </form>
