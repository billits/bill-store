  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          <!-- Breadcrumbs-->
          <ol class="breadcrumb">
          Free Produk Office <?php echo $_COOKIE['office_bill']; ?>
          </ol>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class='modal-title' id='exampleModalLabel'>Free Produk</h5>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var datastok = "data_trans_fp.php?nota="+idnota;
        $('#Transaksi').load(datastok); 

        $(document).on('click','#addpro',function(e){
          e.preventDefault();
          window.location= 'add_trans_pro_fp.php?nota='+idnota;
        });
        ...
        $('#form-approv').submit(function(e){
          ...
          $.ajax({
            url:"../db_proses/add_trans_fp.php",
            type:"POST",
            data: dataform,
            success:function(result){
              ...
              if(obj.nilai===1){
                ...
                window.open(
                  '../Print Nota NFB.php?nota='+nota_tmp,
                  '_blank' // <- This is what makes it open in a new window.
                );
                window.location= 'pro_free.php';
              }else{
                alert(obj.error); 
              }
            }
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                callback: function() {
                  $.post('../db_proses/delete_trans_fp.php', { 'kode_nota':pnot, 'kode_produk':ppdk, 'jum_produk':pjum })
                  .done(function(html){      
                    $('#Transaksi').load(datastok);   
                  })
                  .fail(function(){
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                className: "btn-success",
                callback: function() {
                  $.post('../db_proses/delete_transaksi_fp.php', { 'kode_nota':pnot })
                  .done(function(html){             
                    window.location= 'pro_free.php';
                  })
                  .fail(function(){
