  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          <!-- Breadcrumbs-->
          <ol class="breadcrumb">
            Free Produk Office BillStore <?php echo $_COOKIE['office_bill']; ?>
          </ol>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var ListPro = "list_pro_fp.php";
        $('#ListPro').load(ListPro); 

        $(document).on('click','#kembali',function(e){
          e.preventDefault();
          window.location= 'add_trans_fp.php?nota='+idnota;
        });
        ...
        $("#form-jum").submit(function(e) {
          ...
          $.ajax({
            url: "../db_proses/add_trans_pro_fp.php",
            type: "POST",
            data: dataform,
