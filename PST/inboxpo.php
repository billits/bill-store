      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Inbox PO Cabang </li>
          </ol>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "data_detpo.php?id="+datatmp;
          $('#DataPO').load(datalap); 
        });
        ...
        $(document).on('click','#aprov',function(e){
          ...
          $.ajax({
            url: "../db_proses/update_po_cabang.php",
            type: "POST",
            data: dataform,
        ...
        $("#form-edit").submit(function(e) {
          ...
          $.ajax({
            url: "../db_proses/update_poproduk_cb.php",
            type: "POST",
            data: dataform,
            success:function(result){
              var obj= JSON.parse(result);
              if(obj.nilai===1){
                ...
                var datalap = "data_detpo.php?id="+obj.link;
                $('#DataPO').load(datalap); 
              }else{
                alert(obj.error); 
              }
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                callback: function() {
                  $.post('../db_proses/delete_addproduk_cb.php', { 'kode_nota':pnot, 'kode_produk':ppdk, 'kode_jum':pjum })
                  .done(function(html){             
                    var datalap = "data_detpo.php?id="+pnot;
                    $('#DataPO').load(datalap); 
                  })
                  .fail(function(){
