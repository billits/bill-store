  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Print Ulang Konsinyasi Event Cabang</li>
          </ol>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var datatrans = "data_pu_evt.php?tgl_start="+tgl_start+"&tgl_end="+tgl_end+"&kantor="+kantor+"&event="+event;
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "data_det_pu_evt.php?id="+datatmp;
