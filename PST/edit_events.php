...
?>
                  ...
                  <form method="post" id="form-edit-region">
                    ...
                    <div class="form-group" style="padding-bottom: 20px;">
                      <label for="statevt">Status Events NOW</label>
                      <input type="text" name="statevt" id="statevt" class="form-control" readonly value="<?php echo $baris['status_det_event']; ?>" required/>
                    </div>
                    <div class="form-group" style="padding-bottom: 20px;">
                      <label for="statevt1">Ganti Status Events*</label>
                      <select class="form-control" name="statevt1" id="statevt1">
                        <option value="">Pilih Status Events</option>
