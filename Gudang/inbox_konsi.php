      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Inbox Konsinyasi Leader <?php echo $_COOKIE['office_bill']; ?></li>
          </ol>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $(document).on('click','#aprov',function(e){
          ...
          $.ajax({
            url: "../db_proses/update_konsi_stog.php",
            type: "POST",
            data: dataform,
