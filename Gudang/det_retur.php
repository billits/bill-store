  ...
  <body id="page-top">
                ...
                <div class="modal-body">
                  <form method="post" id="form-save">
                    <div class="form-group" style="padding-bottom: 20px;">
                      ...
                      <input type="hidden" name="evnt" id="evnt" value="">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        var evt = getUrlVars()["evt"];
        var nota = getUrlVars()["nota"];
        
        var datatrans = "data_rt_evt.php?nota="+nota+"&evt="+evt;
        ...
        $('#form-save').submit(function(e){
          ...
          $.ajax({
            url:"../db_proses/add_save_returevt1.php",
            type:"POST",
            data: dataform,
            success:function(result){
              ...
              if(obj.nilai===1){
                ...
                window.open(
                  '../Print Nota NTR Event.php?nota='+nota_tmp,
        ...
        $('#form-reall').submit(function(e){
          ...
          $.ajax({
            url:"../db_proses/add_save_returevt_all1.php",
            type:"POST",
            data: dataform,
            success:function(result){
              var obj= JSON.parse(result);
        ...
        $("#form-retur").submit(function(e) {
          ...
          $.ajax({
            url: "../db_proses/update_retevt_produk.php",
            type: "POST",
            data: dataform,
            success:function(result){
              var obj= JSON.parse(result);
