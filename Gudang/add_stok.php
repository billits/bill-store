    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <!-- Modal Popup untuk Order Data Produk--> 
                ...
                <div class="modal-body">
                  ...
                  <form method="post" id="form-approv">                  
                    ...
                    <div class="modal-footer">
                      <button class="btn btn-success" id="btn-save" type="submit">Ya</button>
                      <button type="reset" class="btn btn-danger"  data-dismiss="modal" aria-hidden="true">Tidak</button>
                    </div>
                  </form>
                </div>
              </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $('#form-approv').submit(function(e){
          ...
          $.ajax({
            url:"../db_proses/add_orderproduk_cb.php",
            type:"POST",
            data: dataform,
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                callback: function() {
                  $.post('../db_proses/delete_addproduk_po.php', { 'kode_nota':pnot, 'kode_produk':ppdk })
                  .done(function(html){             
                    $('#TambahStok').load(datastok);   
                  })
                  .fail(function(){
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                className: "btn-success",
                callback: function() {
                  $.post('../db_proses/delete_stok_po.php', { 'kode_nota':pnot })
                  .done(function(html){             
                    window.location= 'storageoffice.php';
                  })
                  .fail(function(){
