  ...
  <body id="page-top">
                ...
                <div class="modal-body">
                  <form method="post" id="form-save">
                    <div class="form-group" style="padding-bottom: 20px;">
                      ...
                      <input type="hidden" name="konsi" id="konsi" value="">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        var konsi = getUrlVars()["konsi"];
        var nota = getUrlVars()["nota"];
        
        var datatrans = "data_rt_konsi.php?nota="+nota+"&konsi="+konsi;
        ...
        $(document).on("click", ".open-ModalSave", function () {   
          ...
          var konsi = $(this).data('konsi');
          var cont = $(this).data('cont');
           
          $(".modal-body #nota").val( id_nota );
          $(".modal-body #bayar").val( total_bayar );
          $(".modal-body #konsi").val( konsi );
          $(".modal-body #cont").val( cont );
        });
        ...
        $('#form-save').submit(function(e){
          ...
          $.ajax({
            url:"../db_proses/add_save_retur_konsi.php",
            type:"POST",
            data: dataform,
        ...
        $('#form-reall').submit(function(e){
          ...
          $.ajax({
            url:"../db_proses/add_save_retur_konsi_all.php",
            type:"POST",
            data: dataform,
            success:function(result){
              var obj= JSON.parse(result);
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                callback: function() {
                  $.post('../db_proses/reset_retur_konsi.php', { 'kode_nota':pnot, 'kode_pro':ppdk })
                  .done(function(html){             
        ...
        $(document).on('click','#retur',function(e){
          ...
          $.post('retur_pdk.php',
            {pdk:$(this).attr('data-pdk'),
              ...
              evt1:$(this).attr('data-evt'),
              ret:$(this).attr('data-ret'),
              laku:$(this).attr('data-laku'),
        ...
        $("#form-retur").submit(function(e) {
          ...
          $.ajax({
            url: "../db_proses/update_retkons_produk.php",
            type: "POST",
            data: dataform,
            success:function(result){
              var obj= JSON.parse(result);
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                className: "btn-success",
                callback: function() {
                  $.post('../db_proses/delete_retur_konsi.php', { 'kode_nota':pnot })
                  .done(function(html){             
                    window.location= 'ru_konsi.php';
                  })
                  .fail(function(){
