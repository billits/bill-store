  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Inbox Manual Konsinyasi Leader <?php echo $_COOKIE['office_bill']; ?></li>
          </ol>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        var datapo = "data_po_man_konsi.php";
        $('#DataPO').load(datapo); 
        ...
        $(document).on('click','#aprov',function(e){
          ...
          $.ajax({
            url: "../db_proses/update_man_konsi.php",
            type: "POST",
            data: dataform,
