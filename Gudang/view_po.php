  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Print Ulang PO Pusat</li>
          </ol>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var datatrans = "data_po_pusat.php?tgl_start="+tgl_start+"&tgl_end="+tgl_end;
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "data_det_po_pusat.php?id="+datatmp;
