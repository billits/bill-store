      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Inbox Transaksi Office <?php echo $_COOKIE['office_bill']; ?></li>
          </ol>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "data_dettrans.php?id="+datatmp;
          $('#DataPO').load(datalap); 
        });
        ...
        $(document).on('click','#aprov',function(e){
          ...
          $.ajax({
            url: "../db_proses/update_trans_stog.php",
            type: "POST",
            data: dataform,
