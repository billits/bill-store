      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Inbox Retur Transaksi <?php echo $_COOKIE['office_bill']; ?></li>
          </ol>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "data_det_rettrans.php?id="+datatmp;
          $('#DataPO').load(datalap); 
        });
        ...
        $(document).on('click','#kembali',function(e){
          ...
          $.ajax({
            url: "../db_proses/update_ret_trans.php",
            type: "POST",
            data: dataform,
