  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Laporan Gudang Kantor <?php echo $_COOKIE['office_bill']; ?></li>
          </ol>
    ...
    function getUrlVars() {
      ...
      $(document).ready(function(){
        ...
        var datapo = "data_rekap_konsi.php?tgl_start="+tgl_start+"&tgl_end="+tgl_end;
        $('#DataPO').load(datapo); 
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "data_det_kons.php?id="+datatmp;
          $('#DataPO').load(datalap); 
        });
