<?php
  ...
  $sqlre= "SELECT * FROM tb_free_produk 
  INNER JOIN tb_staff ON tb_staff.kode_staff=tb_free_produk.staff_fp 
...
<body>
  ...
  <br><br><br><br><br><br><br><br>
    ...
    <font face='arial' size='2'>Staff  : <?php echo $rowre['nama_staff']; ?> <br> </font>
    <font face='arial' size='2'>Keterangan  : <?php echo $rowre['keterangan_fp']; ?> </font>
  ...
  <?php
    ...
    $bayar=0;
    $query2="SELECT * FROM tb_detail_fp INNER JOIN tb_free_produk ON tb_free_produk.id_fp=tb_detail_fp.id_detfp 
    ...
    while($baris2 = mysqli_fetch_assoc($result2)){
      $bayar=$bayar+$baris2['totjum_detfp'];
  ?>
      <tr>
        <td width="30%"><font face='verdana' size='2'><?php echo $baris2['id_produk']; ?><br>(<?php echo $baris2['jum_detfp']; ?>)</font></td>
        <td width="35%"><font face='verdana' size='2'><?php echo $baris2['nama_produk']; ?><br>(<?php echo rupiah($baris2['harga_harian']); ?>)</font></td>
        <td width="6%"><font face='verdana' size='2'><?php echo rupiah($baris2['diskon_detfp']); ?></font></td>
        <td width="20%"><font face='verdana' size='2'><?php echo rupiah($baris2['total_fp']); ?></font></td>
      </tr>
  ...
  ?>  
      ...
      <tr>
        ...
        <td colspan="3"><font face='verdana' size='2'>  : <?php echo "0"; ?></font></td>
      </tr>
      <tr>
      ...
      <tr></tr> <tr></tr> <tr></tr> 
      <tr>
        <td width="25%" colspan="4"><font face='verdana' size='2'>Jenis Transaksi : <?php echo "Free Produk"; ?></td>
      </tr>
      <tr>
        <td width="25%" colspan="4"><font face='verdana' size='2'>Tanggal dan Waktu : <?php echo date("d-m-Y H:i:s", strtotime($rowre['waktu_fp'])); ?>  </td>
      </tr>
      <tr>
