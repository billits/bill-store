<?php
  ...
  if (empty($id)||empty($evt)||empty($off)){
	...
	if ($valid==0){
		...
		$sql = "INSERT INTO tb_beli_event (id_beli_event, tgl_beli_event, total_beli_event, cara_bayar_beli_event, jenis_beli_event, event_beli_event, staff_beli_event, kantor_beli_event, keterangan_beli_event, stat_beli_event, supplier_beli_event) 
		VALUES ('$kode', NOW(), '0', 'KONSI', 'SUPPLY', '$evt', '$id', '$off', '0', 'PENDING', '$id')";
