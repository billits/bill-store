  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          <!-- Breadcrumbs-->
          <ol class="breadcrumb">
            Manual Konsi Leader <?php echo $_COOKIE['office_bill']; ?>
          </ol>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var datastok = "data_man_add_konsi.php?nota="+idnota;
        $('#Transaksi').load(datastok); 

        $(document).on('click','#addpro',function(e){
          e.preventDefault();
          window.location= 'add_man_konsi_pro.php?nota='+idnota;
        });
        ...
        $('#form-approv').submit(function(e){
          ...
          $.ajax({
            url:"../db_proses/add_man_konsi.php",
            type:"POST",
            data: dataform,
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                callback: function() {
                  $.post('../db_proses/delete_man_konsi.php', { 'kode_nota':pnot, 'kode_produk':ppdk, 'jum_produk':pjum })
                  .done(function(html){      
                    $('#Transaksi').load(datastok);   
                  })
                  .fail(function(){
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                className: "btn-success",
                callback: function() {
                  $.post('../db_proses/delete_man_konsinyasi.php', { 'kode_nota':pnot })
                  .done(function(html){             
                    window.location= 'man_konsi.php';
                  })
                  .fail(function(){
