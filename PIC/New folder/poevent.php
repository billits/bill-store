  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Laporan PO Event Kantor <?php echo $_COOKIE['nama_office']; ?></li>
          </ol>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        var databtb = "data_rekapbtb_event.php";
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "data_repbtb_evt.php?id="+datatmp;
