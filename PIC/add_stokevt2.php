...
<html lang="en">
  ...
  <?php      
    ...
    $sql2= "SELECT * FROM tb_detail_events WHERE id_det_event = '$evt' ";
    $result2 = mysqli_query($kon,$sql2);	  
    $row2 = mysqli_fetch_array($result2,MYSQLI_ASSOC);
    $event = $row2['nama_det_event'];
  ?>
  Tambah Stok Produk Gudang <?php echo "Event ".$event." ".$_COOKIE['office_bill']; ?>
          </ol>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class='modal-title' id='exampleModalLabel'>Update Stok Produk  <?php echo "Event ".$event; ?></h5>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $(document).on('click','#addpro',function(e){
          e.preventDefault();
          window.location= 'add_stokproevt2.php?nota='+idnota+'&evt='+idevt;
        });
        ...
        $('#form-approv').submit(function(e){
          ...
          $.ajax({
            url:"../db_proses/add_orderprodukevt2.php",
            type:"POST",
            data: dataform,
