  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          <!-- Breadcrumbs-->
          <ol class="breadcrumb">
            Transaksi Event BillStore <?php echo $_COOKIE['office_bill']; ?>
          </ol>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var ListPro = "list_pro_evt1.php?nota="+idnota;
        ...
        $("#form-jum").submit(function(e) {
          ...
          $.ajax({
            url: "../db_proses/add_trans_pro_evt.php",
            type: "POST",
            data: dataform,
