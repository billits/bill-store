      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Print Ulang Transaksi Event <?php echo $_COOKIE['office_bill']; ?>  Per Item</li>
          </ol>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $(document).on('click','#delet',function(e){
          e.preventDefault();
                alert("Cancel hanya bisa dihari yang sama di Menu Transaksi Event"); 
        });
