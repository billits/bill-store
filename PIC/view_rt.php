  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Print Ulang Retur Transaksi <?php echo $_COOKIE['office_bill']; ?>  Per Item</li>
          </ol>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var datatrans = "retur_trans.php?tgl_start="+tgl_start+"&tgl_end="+tgl_end;
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "data_detail_rt_trans.php?id="+datatmp;
