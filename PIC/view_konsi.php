  ...
  <body id="page-top">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var datatrans = "konsi_off_pu.php?tgl_start="+tgl_start+"&tgl_end="+tgl_end;
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "detail_konsi_off_pu.php?id="+datatmp;
        ...
        $(document).on('click','#delet',function(e){
          e.preventDefault();
          bootbox.alert('Cancel Hanya Bisa di Hari Sama dan di Menu Konsi Leader');
