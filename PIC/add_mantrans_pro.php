  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          <!-- Breadcrumbs-->
          <ol class="breadcrumb">
            Manual Transaksi Office BillStore <?php echo $_COOKIE['office_bill']; ?>
          </ol>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var ListPro = "list_pro_man.php";
        $('#ListPro').load(ListPro); 

        $(document).on('click','#kembali',function(e){
          e.preventDefault();
          window.location= 'add_man_trans.php?nota='+idnota;
        });

        $(document).on('click','#jum',function(e){
          e.preventDefault();
          $("#ModalJum").modal('show');
          $.post('set_jml_man.php',
        ...
        $("#form-jum").submit(function(e) {
          ...
          $.ajax({
            url: "../db_proses/add_man_trans_pro.php",
            type: "POST",
            data: dataform,
            success:function(result){
              ...
              if(obj.nilai===1){
                alert(obj.error);                 
                // window.location= 'add_trans.php?nota='+idnota;
                $("#ModalJum").modal('hide');
                $('#ListPro').load(ListPro);
              }else{
                alert(obj.error); 
