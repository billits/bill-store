      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <?php
            ...
            $evts = $_GET['evn'];
            $sqlev= "SELECT * FROM tb_detail_events WHERE id_det_event='$evts'";
            $resultev = mysqli_query($kon,$sqlev);
            $rowev = mysqli_fetch_array($resultev,MYSQLI_ASSOC);
          ?>
          <ol class="breadcrumb">
            Tambah Stok Produk Gudang <?php echo "Event ".$rowev['nama_det_event']; ?>
          </ol>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class='modal-title' id='exampleModalLabel'>Update Stok Produk Gudang Event</h5>
          ...
          $.ajax({
            ...
            success:function(result){
              ...
              if(obj.nilai===1){
                ...
                window.location= 'storageevent.php';
              }else{
                alert(obj.error); 
              }
            }
