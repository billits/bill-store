  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          <!-- Breadcrumbs-->
          <ol class="breadcrumb">
            Manual Transaksi Events <?php echo $_COOKIE['office_bill']; ?>
          </ol>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class='modal-title' id='exampleModalLabel'>Transaksi Event</h5>
                ...
                <div class="modal-body">
                  <form method="post" id="form-approv">
                    ...
                    <div class="form-group" style="padding-bottom: 20px;">
                      <label for="tlp">Telepon Pelanggan*</label>
                    ...
                    <div class="form-group" style="padding-bottom: 20px;">
                      ...
                      <input class="form-control" type="text" name="Voucher" id="Voucher" value="0" onkeyup="myFunction()" required/>  
                    </div>
                    <div class="form-group" style="padding-bottom: 20px;">
                    ...
                    <div class="form-group" style="padding-bottom: 20px;">
                      ...
                      <input class="form-control" type="text" name="Dibayar" id="Dibayar" onkeyup="myFunction()" required/>  
                    </div>
                    <div class="form-group" style="padding-bottom: 20px;">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var datastok = "data_man_trans_evt.php?nota="+idnota;
        $('#Transaksi').load(datastok); 

        $(document).on('click','#addpro',function(e){
          e.preventDefault();
          window.location= 'add_man_trans_pro_evt.php?nota='+idnota;
        });
        ...
        $('#form-approv').submit(function(e){
          ...
          $.ajax({
            url:"../db_proses/add_man_trans.php",
            type:"POST",
            data: dataform,
            success:function(result){
              ...
              if(obj.nilai===1){
                ...
                var evtt_tmp = obj.evtt;
                window.open(
                  '../Print Nota MNJ1.php?nota='+nota_tmp,
                  '_blank' // <- This is what makes it open in a new window.
                );
                window.location= 'man_transaksi_det_evt.php?evt='+evtt_tmp;
              }else{
                alert(obj.error); 
              }
            }
          ...
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                callback: function() {
                  $.post('../db_proses/delete_man_trans.php', { 'kode_nota':pnot, 'kode_produk':ppdk, 'jum_produk':pjum })
                  .done(function(html){      
                    $('#Transaksi').load(datastok);   
                  })
                  .fail(function(){
        ...
        $(document).on('click','#batal',function(e){
          e.preventDefault();
          var pnot = $(this).attr('data-nota');
          var pevtt = $(this).attr('data-acara');
          bootbox.dialog({
            ...
            buttons: {
              danger: {
                ...
                className: "btn-success",
                callback: function() {
                  $.post('../db_proses/delete_man_transaksi.php', { 'kode_nota':pnot })
                  .done(function(html){             
                    window.location= 'man_transaksi_det_evt.php?evt='+pevtt;
                  })
                  .fail(function(){
                    bootbox.alert('Something Went Wrog ....');
                  })
