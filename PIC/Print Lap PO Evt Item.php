  ...
  <head>
    ...
    <?php
      if($model=="REKAP"){
        ...
        if ($pdk=="ALL"){
          ...
          WHERE tb_beli_event.kantor_beli_event='$kantor'";
          ...
          while($baris = mysqli_fetch_assoc($result)){
            ...
            if ($nota=="ALL"){
                ...
                INNER JOIN tb_beli_event ON tb_beli_event.id_beli_event=tb_detail_beli_event.nota_detbelev
                WHERE tb_beli_event.kantor_beli_event='$kantor' AND tb_detail_beli_event.produk_detbelev='$det_pdk' AND tb_beli_event.event_beli_event='$event' AND tb_beli_event.tgl_beli_event BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
            }else{
                $query1="SELECT * FROM tb_produk 
                INNER JOIN tb_detail_beli_event ON tb_detail_beli_event.produk_detbelev=tb_produk.id_produk 
                INNER JOIN tb_beli_event ON tb_beli_event.id_beli_event=tb_detail_beli_event.nota_detbelev
                WHERE tb_beli_event.kantor_beli_event='$kantor' AND tb_detail_beli_event.produk_detbelev='$det_pdk' AND tb_beli_event.event_beli_event='$event' AND tb_detail_beli_event.nota_detbelev BETWEEN '$nota_start' AND '$nota_end' AND tb_beli_event.tgl_beli_event BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
            }
    ...
    <?php
            ...
            if ($nota=="ALL"){
              ...
              INNER JOIN tb_detail_beli_event ON tb_detail_beli_event.produk_detbelev=tb_produk.id_produk 
              INNER JOIN tb_beli_event ON tb_beli_event.id_beli_event=tb_detail_beli_event.nota_detbelev
              WHERE tb_beli_event.kantor_beli_event='$kantor' AND tb_detail_beli_event.produk_detbelev='$pdk' AND tb_beli_event.event_beli_event='$event' AND tb_beli_event.tgl_beli_event BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
            }else{
                $query1="SELECT * FROM tb_produk 
                INNER JOIN tb_detail_beli_event ON tb_detail_beli_event.produk_detbelev=tb_produk.id_produk 
                INNER JOIN tb_beli_event ON tb_beli_event.id_beli_event=tb_detail_beli_event.nota_detbelev
                WHERE tb_beli_event.kantor_beli_event='$kantor' AND tb_detail_beli_event.produk_detbelev='$pdk' AND tb_beli_event.event_beli_event='$event' AND tb_detail_beli_event.nota_detbelev BETWEEN '$nota_start' AND '$nota_end' AND tb_beli_event.tgl_beli_event BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
            }
    ...
    <?php
                ...
                if ($nota=="ALL"){
                  ...
                  INNER JOIN tb_detail_beli_event ON tb_detail_beli_event.produk_detbelev=tb_produk.id_produk 
                  INNER JOIN tb_beli_event ON tb_beli_event.id_beli_event=tb_detail_beli_event.nota_detbelev
                  WHERE tb_beli_event.kantor_beli_event='$kantor' AND tb_detail_jual.produk_detjual='$pdk' AND tb_beli_event.event_beli_event='$event' AND tb_beli_event.tgl_beli_event BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
                  ...
                  INNER JOIN tb_detail_beli_event ON tb_detail_beli_event.produk_detbelev=tb_produk.id_produk 
                  INNER JOIN tb_beli_event ON tb_beli_event.id_beli_event=tb_detail_beli_event.nota_detbelev
                  WHERE tb_tb_beli_event.kantor_beli_event='$kantor' AND tb_detail_beli_event.produk_detbelev='$pdk' AND tb_beli_event.event_beli_event='$event' AND tb_detail_beli_event.nota_detbelev BETWEEN '$nota_start' AND '$nota_end' AND tb_beli_event.tgl_beli_event BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
              }
