  ...
  <body id="page-top">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> Print Ulang Manual Konsi</li>
          </ol>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        var datatrans = "konsi_off_pu_man.php?tgl_start="+tgl_start+"&tgl_end="+tgl_end;
        ...
        $(document).on('click','#detail',function(e){
          ...
          var datalap = "detail_konsi_off_pu_man.php?id="+datatmp;
