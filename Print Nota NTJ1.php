<?php
  ...
  $sqlre= "SELECT * FROM tb_jual 
  INNER JOIN tb_staff ON tb_staff.kode_staff=tb_jual.counter_jual 
...
<body>
  ...
  <br><br><br><br><br><br><br><br>
    ...
    <font face='arial' size='2'>Customer  : <?php echo $rowre['nama_customer']; ?> <br> </font>
    <font face='arial' size='2'>Keterangan  : <?php echo $rowre['keterangan_jual']; ?> </font>
  ...
  ?>
      <tr>
        <td width="30%"><font face='verdana' size='2'><?php echo $baris2['id_produk']; ?><br>(<?php echo $baris2['qty_detjual']; ?>)</font></td>
        <td width="35%"><font face='verdana' size='2'><?php echo $baris2['nama_produk']; ?><br>(<?php echo rupiah($baris2['harga_harian']); ?>)</font></td>
        <td width="6%"><font face='verdana' size='2'><?php echo rupiah($baris2['diskon_detjual']); ?></font></td>
        <td width="20%"><font face='verdana' size='2'><?php echo rupiah($baris2['total_jumlah_detjual']); ?></font></td>
      </tr>
  ...
  ?>  
      ...
      <tr></tr> <tr></tr> <tr></tr> 
      <tr>
        <td width="25%" colspan="4"><font face='verdana' size='2'>Jenis Transaksi : <?php echo $rowre['jenis_jual']." - ".$rowre['cara_bayar_jual']; ?></td>
      </tr>
      <tr>
        <td width="25%" colspan="4"><font face='verdana' size='2'>Tanggal dan Waktu : <?php echo date("d-m-Y H:i:s", strtotime($rowre['tgl_order_jual'])); ?>  </td>
      </tr>
      <tr>
