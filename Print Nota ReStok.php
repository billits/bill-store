<?php
  ...
  $sqlre= "SELECT * FROM tb_restok INNER JOIN tb_staff ON tb_staff.kode_staff=tb_restok.staff_restok 
  INNER JOIN tb_office ON tb_office.id_office=tb_restok.kantor_restok WHERE tb_restok.id_restok='$nota'";
  ...
  <font face="verdana" size="-2">
    <p>
      <div align="center">
        ...
        <font face="verdana" size="5">RESTOK GUDANG PRODUK</font><br><br>
      </div>
      <table width="100%">
        <tr>
          <td>
            <table>
              ...
              <tr><td>Tanggal</td><td>:</td><td><?php echo date("d-m-Y H:i:s", strtotime($rowre['tgl_restok'])); ?></td>
          ...
          <td>
            <table>
              ...
              <tr><td>Keterangan</td><td>:</td><td><?php echo $rowre['keterangan_restok']; ?></td>
              <tr><td>Status</td><td>:</td><td><?php echo $rowre['status_restok']; ?></td>
            </table>
          </td>
        </tr>
      </table>
    ...
    <?php
      ...
      $bayar=0;
      $query2="SELECT * FROM tb_detail_restok INNER JOIN tb_restok ON tb_restok.id_restok=tb_detail_restok.nota_detrestok 
      ...
      while($baris2 = mysqli_fetch_assoc($result2)){
        $bayar=$bayar+$baris2['total_jumlah_detrestok'];
        $produk=$baris2['id_produk'];
        $totju=$baris2['total_restok'];
        
    ?>
      <tr>
        <td align="center" style="border:1px solid black; padding:5px; border-collapse: collapse;"><?php echo $baris2['qty_detrestok']; ?></td>
        ...
        <td style="border:1px solid black; padding:5px; border-collapse: collapse;"><?php echo rupiah($baris2['total_jumlah_detrestok']); ?></td>
      </tr>
    <?php
      }
    ?>  
      <tr>
        ...
        <td style="border:1px solid black; padding:5px; border-collapse: collapse;"> <?php echo rupiah($rowre['total_restok']); ?> </td>
      </tr>
    </table>
    <br>
    <table width="50%" border="0" align="right">
      <tr>
        <th width="50%" scope="col" align="center"><font size="-1">Membuat</font> </th>
      </tr>
    </table>
    <br><br><br><br>
    <table width="50%" border="0" align="right">
